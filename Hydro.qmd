...
writeRaster(slope, "~/Documents/Qgis/teal/Hoh_data/stacked/TopoHoh-slope.tif",  gdal=c("COMPRESS=LZW"))
...
writeRaster(TPI, "~/Documents/Qgis/teal/Hoh_data/stacked/TopoHoh-TPI.tif",  gdal=c("COMPRESS=LZW"))
# Save or plot the result
plot(TPI, main = "TPI")
```

# Profile curvature using R
...
sca <- terrain(finescaledem, "flowdir")
