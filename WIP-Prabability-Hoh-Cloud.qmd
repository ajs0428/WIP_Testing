---
title: "WIP-Prabability-Hoh-Cloud"
format: html
editor: visual
---
...
# Use the below only if loading the individual rasters and stacking
...
```{r}
pred_wip_prob <- predict(terr_stack, rf_model, fun = predict, type = "prob")
# Save the predicted raster
writeRaster(pred_wip_prob, "~/Documents/Qgis/teal/Hoh_data/stacked/TopoHoh-predicted-wip-prob.tif", gdal=c("COMPRESS=LZW"),overwrite = TRUE)
...
writeRaster(smoothed_raster_prob,  "~/Documents/Qgis/teal/Hoh_data/stacked/TopoHoh-predicted-wip-smoothed-prbability.tif", gdal=c("COMPRESS=LZW"),overwrite = TRUE)

# Plot the predicted raster
plot(smoothed_raster_prob, main = "Predicted WIP- Smoothed")
```
